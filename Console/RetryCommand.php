...
class RetryCommand extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($ids as $id) {
            $job = $this->venusian['queue.failer']->find($id);
            ...
            if (is_null($job)) {
                ...
                $this->venusian['queue.failer']->forget($id);
            }
        }
    ...
    {
        $queue = $this->venusian['queue']->connection($job->connection);

        $this->venusian['queue']->connection($job->connection)->pushRaw(
