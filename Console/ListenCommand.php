...
class ListenCommand extends Command
{
     ...
     *
     * @param  \Voyager\Queue\Listener  $listener
     */
    ...
    {
        $connection = $connection ?: $this->venusian['config']['queue.default'];

        return $this->input->getOption('queue') ?: $this->venusian['config']->get(
     ...
     *
     * @return \Voyager\Queue\ListenerOptions
     */
