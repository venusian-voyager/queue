...
class WorkCommand extends Command
{
     ...
     *
     * @param  \Voyager\Queue\Worker  $worker
    ...
    public function handle()
    {
        ...
        $connection = $this->argument('connection')
            ?: $this->venusian['config']['queue.default'];
     ...
     *
     * @return \Voyager\Queue\WorkerOptions
     */
    ...
    {
        $queueTimezone = $this->venusian['config']->get('queue.output_timezone');

        if ($queueTimezone &&
            $queueTimezone !== $this->venusian['config']->get('app.timezone')) {
    ...
    {
        return $this->option('queue') ?: $this->venusian['config']->get(
