...
/**
 * @mixin \Voyager\Queue\QueueManager
 * @mixin \Voyager\Contracts\Queue\Queue
 */
class Manager
{
     ...
     *
     * @var \Voyager\Queue\QueueManager
     */
    protected $manager;
    ...
    {
        $this->vessel['config']['queue.default'] = 'default';
    }
    ...
    {
        $this->manager = new QueueManager($this->vessel);
    }
    ...
    {
        $provider = new QueueServiceProvider($this->vessel);
    ...
    {
        $this->vessel['config']["queue.connections.{$name}"] = $config;
    }

    /**
     * Get the queue manager instance.
     *
     * @return \Voyager\Queue\QueueManager
     */
