...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param  \Voyager\Database\Connection  $database
     * @param  string  $table
     ...
     *
     * @param  string|null  $queue
     * @return \Voyager\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     * @param  string  $queue
     * @param  \Voyager\Queue\Jobs\DatabaseJobRecord  $job
     * @return \Voyager\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param  string  $queue
     * @param  \Voyager\Queue\Jobs\DatabaseJob  $job
     * @param  int  $delay
     * @return void
     */
