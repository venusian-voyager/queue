...
class Worker
{
     ...
     * @param  string  $queue
     * @param  \Voyager\Queue\WorkerOptions  $options
     * @return int
     */
     ...
     *
     * @param  \Voyager\Contracts\Queue\Job|null  $job
     * @param  \Voyager\Queue\WorkerOptions  $options
     * @return void
     */
     ...
     *
     * @param  \Voyager\Contracts\Queue\Queue  $connection
     * @param  string  $queue
     ...
     *
     * @param  int  $status
     * @param  \Voyager\Queue\WorkerOptions|null  $options
     * @param  \Voyager\Queue\WorkerStopReason|null  $reason
     * @return never
     */
     ...
     *
     * @param  \Voyager\Contracts\Queue\Job  $job
     * @return \Voyager\Queue\MaxAttemptsExceededException
     */
     ...
     *
     * @param  \Voyager\Contracts\Queue\Job  $job
     * @return \Voyager\Queue\TimeoutExceededException
     */
     ...
     *
     * @return \Voyager\Contracts\Queue\Factory
     */
